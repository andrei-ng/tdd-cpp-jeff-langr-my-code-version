...
PlaceDescriptionService::PlaceDescriptionService() : http_{std::make_shared<CurlHttp>()} {}
...
std::shared_ptr<Http> PlaceDescriptionService::GetHttpService() const { return http_; }
